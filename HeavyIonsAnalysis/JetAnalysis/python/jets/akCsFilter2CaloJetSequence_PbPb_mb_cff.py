...
akCsFilter2CalomatchGroomed = patJetGenJetMatch.clone(
...
#akCsFilter2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))
...
akCsFilter2CaloJetSequence = cms.Sequence(akCsFilter2CaloJetSequence_mb)
