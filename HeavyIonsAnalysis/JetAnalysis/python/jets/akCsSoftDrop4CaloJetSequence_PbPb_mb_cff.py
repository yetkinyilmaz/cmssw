...
#akCsSoftDrop4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))
...
akCsSoftDrop4CaloJetSequence = cms.Sequence(akCsSoftDrop4CaloJetSequence_mb)
