...
akCsSoftDrop4CaloJetSequence = cms.Sequence(akCsSoftDrop4CaloJetSequence_jec)
akCsSoftDrop4CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDrop4CaloJetAnalyzer.jetPtMin = cms.double(1)
